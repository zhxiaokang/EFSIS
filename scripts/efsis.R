...
# Inherited from 'efsis_main_btsp.R', use 10-folds cross validation, and 50 rounds for bootstrap resampling, when calculating the stab, use the original # sel fea, no 10 times
# new updates compared with 'efsis_main_btsp.R': 
# 1. use Kuncheva consistency index to calculate stab
# 2. record the selected features and save them into files
# 3. will be used as the main function and will not change the code for each dataset
